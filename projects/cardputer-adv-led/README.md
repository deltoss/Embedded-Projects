...
A minimal M5Stack Cardputer ADV sketch. It turns the onboard SK6812 RGB LED white for one second, off for one second, repeats 15 times, then disables LED power.
